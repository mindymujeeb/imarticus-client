    ...
    <div className='course-video-div-complete'>
      ...
      <div className='course-video-div'>
          ...
          <div className="accordion accordian-div-course" id="accordionExample">
              ...
              <div id="collapseOne" className="accordion-collapse collapse hide" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                <div className="accordion-body">
                  <div className='accordian-body-div'>
                    ...
                    <Link to={`/my-courses/imarticus-student-testimonials/63c66547a99988c2401b764b`} className='link-video' ><p className='video-text-accordian-body'>listen to their perspectives</p></Link>
            ...
            <div className="accordion-item">
              ...
              <div id="collapseTwo" className="accordion-collapse collapse hide" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                <div className="accordion-body">
                  <div className='accordian-body-div'>
                    <img className='image-play-button' alt='help us img' src={playButton}/>
                    <Link to={`/my-courses/imarticus-student-testimonials/63c66559a99988c2401b764d`} className='link-video' ><p className='video-text-accordian-body'>listen to their perspectives</p></Link>
            ...
            <div className="accordion-item">
              ...
              <div id="collapseThree" className="accordion-collapse collapse hide" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                ...
                <div className='accordian-body-div'>
                  <img className='image-play-button' alt='help us img' src={playButton}/>
                  <Link to={`/my-courses/imarticus-student-testimonials/63c665daa99988c2401b764f`}className='link-video' ><p className='video-text-accordian-body'>listen to their perspectives</p></Link>
            ...
            <div className="accordion-item">
              ...
              <div id="collapseFour" className="accordion-collapse collapse hide" aria-labelledby="headingFour" data-bs-parent="#accordionExample">
                ...
                <div className='accordian-body-div'>
                  <img className='image-play-button' alt='help us img' src={playButton}/>
                  <Link to={`/my-courses/imarticus-student-testimonials/63c6660ca99988c2401b7651`}className='link-video' ><p className='video-text-accordian-body'>listen to their perspectives</p></Link>
            ...
            <div className="accordion-item">
              ...
              <div id="collapseFive" className="accordion-collapse collapse hide" aria-labelledby="headingFive" data-bs-parent="#accordionExample">
                ...
                <div className='accordian-body-div'>
                  <img className='image-play-button' alt='help us img' src={playButton}/>
                  <Link to={`/my-courses/imarticus-student-testimonials/63c6662aa99988c2401b7653`}className='link-video' ><p className='video-text-accordian-body'>listen to their perspectives</p></Link>
            ...
            <div className="accordion-item">
              ...
              <div id="collapseSix" className="accordion-collapse collapse hide" aria-labelledby="headingSix" data-bs-parent="#accordionExample">
                ...
                <div className='accordian-body-div'>
                  <img className='image-play-button' alt='help us img' src={playButton}/>
                  <Link to={`/my-courses/imarticus-student-testimonials/63c6663ea99988c2401b7655`}className='link-video' ><p className='video-text-accordian-body'>listen to their perspectives</p></Link>
                  <p className='time-text-accordian-body'>{Time[4]}</p>
                </div>
                </div>
              </div>
        ...
        <div className='course-video-section-2'>
          <p className='course-page-location-text'><Link to='/'>all courses</Link> &gt; <Link to='/my-courses/imarticus-student-testimonials/'>{Name}</Link> &gt; content</p>
          {
            videos.map(({_id, url})=>{
              if(params.id === _id){
                return(
